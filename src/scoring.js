...
export function chooseOffer(lead) {
  ...
  if (has("app", "tool", "crm", "schedul", "booking", "book online", "inventory", "spreadsheet", "manual"))
    return "web_app";
  if (has(" ai", "ai ", "ai feature", "chatbot", "automation")) return "ai_integration";
  if (has("redesign", "revamp", "outdated", "slow", "old site", "not mobile")) return "revamp";
