...
const SAMPLES = {
  website: {
    businessName: "Blue Fig Cafe", contactName: "Priya Shah",
    email: "priya@bluefig.example.com", niche: "cafe", city: "Ahmedabad", website: "",
    hook: "Blue Fig has 4.6 stars on Google but no website, so people can't find your menu online.",
  },
  app: {
    businessName: "BrightPath Coaching", contactName: "Amit Desai",
    email: "amit@brightpath.example.com", niche: "coaching", city: "Vadodara", website: "",
    hook: "Your scheduling is scattered across DMs and Google Forms instead of one booking tool.",
  },
  ai: {
    businessName: "Nova SaaS Labs", contactName: "Karan Joshi",
    email: "karan@novasaas.example.com", niche: "saas", city: "Remote",
    website: "https://novasaas.example.com", notes: "ai",
...
console.log(`\n=== ${lead.businessName} ===`);
console.log(`reliability: ${lead.reliability}/5   offer: ${lead.offer}   niche: ${lead.niche}\n`);
